...
time_format=Label(window, text= "Please Enter Time in 24 hour format only!", fg="white",bg="#922B21",font=("Arial",15)).place(x=20,y=120)
...
submit = Button(window,text = "Set Your Alarm",fg="Purple",bg="White",width = 15,command = get_alarm_time,font=(20)).place(x =100,y=80)
